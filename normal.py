...
PROMPT = (
    ...
    'preserving their identity, face shape, skin tone, and pose, '
    'but make them look completely normal and ordinary: '
    'neutral relaxed expression, tidy conventional hairstyle, '
    'plain everyday clothing, clean unremarkable appearance. '
    'remove any unusual, costume, exaggerated, or distinctive elements. '
